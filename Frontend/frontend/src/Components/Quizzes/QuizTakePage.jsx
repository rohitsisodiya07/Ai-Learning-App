...
const QuizTakePage = () => {
    ...
    const handleSubmitQuiz = async () => {
        ...
        // Check blank short answers
        const hasBlankAnswer =
                        ...
                        <div className="bg-white border border-slate-200 rounded-3xl shadow-sm overflow-hidden">
                            ...
                            <div className="px-5 sm:px-7 py-4 border-b border-slate-100 flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-[11px] font-semibold uppercase tracking-wide px-2.5 py-1 rounded-lg bg-slate-100 text-slate-600">
                                                ...
                                                (
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <span
                                                                className={`flex-1 text-sm sm:text-base font-medium leading-6 ${isSelected
                                                                    ? "text-emerald-900"
                                                                    : "text-slate-700"
                                                                    }`}
                                                            >
                                    ...
                                    "short_answer" && (
                                        ...
                                        <div className="mt-7">
                                            ...
                                            <textarea
                                                ...
                                                rows={6}
                                                className="w-full resize-none rounded-2xl border-2 border-slate-200 bg-white px-4 py-4 text-sm sm:text-base text-slate-700 outline-none transition-all placeholder:text-slate-400 focus:border-emerald-500 focus:bg-emerald-50/30"
                                            />
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
                    ...
                    <div className="relative w-full max-w-md bg-white rounded-3xl shadow-2xl p-6 sm:p-7">
                        ...
                        <p className="text-sm text-slate-500 mt-2 leading-6">
                            ...
                            questions. Once submitted, your answers will be evaluated.
